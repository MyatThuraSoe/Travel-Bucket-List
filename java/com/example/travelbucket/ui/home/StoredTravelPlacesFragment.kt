...
class StoredTravelPlacesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = TravelPlaceAdapter { travelPlace ->
            // Handle the click on a travel place here
            // For now, you can just log the clicked place
            Log.d("StoredTravelPlacesFragment", "Clicked Travel Place: ${travelPlace.city}")
        }
